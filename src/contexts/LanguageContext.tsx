...
const translations = {
  en: {
    ...
    goalBodyRecomp: "Body Recomposition",
    ...
    limitationsHelper: "Select any that apply — exercises stressing these areas will be excluded.",
    limKnee: "Knee",
    limLowerBack: "Lower Back",
    limShoulder: "Shoulder",
    limWrist: "Wrist",
    limAnkle: "Ankle",
    limHip: "Hip",
    limElbow: "Elbow",
    limPregnancy: "Pregnancy",
    limNone: "None",
    ...
    // Intermittent Fasting mode uses generic slot labels (spec §5).
    "meal.meal1": "Meal 1",
    "meal.meal2": "Meal 2",
    "meal.meal3": "Meal 3",
    "meal.meal4": "Meal 4",
  ...
  id: {
    ...
    goalHypertrophy: "Hipertrofi (bangun otot)",
    goalStrength: "Kekuatan",
    goalFatLoss: "Turunkan Lemak",
    goalBodyRecomp: "Rekomposisi Tubuh",
    goalGeneralFitness: "Kebugaran Umum",
    ...
    limitationsHelper: "Pilih yang sesuai — latihan yang membebani area ini akan dikecualikan.",
    limKnee: "Lutut",
    limLowerBack: "Punggung Bawah",
    limShoulder: "Bahu",
    limWrist: "Pergelangan Tangan",
    limAnkle: "Pergelangan Kaki",
    limHip: "Pinggul",
    limElbow: "Siku",
    limPregnancy: "Kehamilan",
    limNone: "Tidak Ada",
    ...
    programDetailsLabel: "Detail Program",
  ...
  zh: {
    ...
    limitationsHelper: "选择适用的项目——涉及这些部位的动作将被排除。",
    limKnee: "膝盖",
    limLowerBack: "下背部",
    limShoulder: "肩膀",
    limWrist: "手腕",
