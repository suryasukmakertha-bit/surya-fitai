...
const TEXT = {
  en: {
    ...
    contextExtendPlan: 'Extending to next month is a Pro feature.',
  ...
  id: {
    ...
    contextExtendPlan: 'Extend program ke bulan berikutnya adalah fitur Pro.',
  ...
  zh: {
    ...
    contextExtendPlan: '将计划延长到下个月是Pro功能。',
