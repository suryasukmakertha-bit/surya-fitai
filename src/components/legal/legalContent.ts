    ...
    sections: [
      ...
      { heading: '4. Subscription and Payments', items: [
        { label: 'Free Tier Access', text: 'Users who are not subscribed can still use the service with the following limitations:', bullets: [
          ...
          'Some features and tabs are locked',
        ]},
        { label: 'Free Trial (14 Days)', text: 'New users receive full access to all features for 14 days, including:', bullets: [
          'Up to 3 plan generations',
          'Up to 3 saved plans',
          'Full access to all features and content',
        ]},
        { label: 'Pro Subscription (Paid)', text: 'After the trial ends, full access requires a Pro subscription priced at Rp 19,900 per month, including:', bullets: [
          'Up to 3 generations per subscription period',
          'Up to 3 saved plans',
          'Full access to all features without restrictions',
        ]},
        { label: 'Expired Status', text: 'When a trial or subscription ends, the account reverts to the Free Tier with limitations:', bullets: [
          'Only the most recent plan is accessible',
          'Other plans are locked',
          'Certain features are restricted',
        ]},
        { label: 'Payments', text: 'Payments are securely processed via Midtrans and support QRIS, GoPay, ShopeePay, Virtual Account, and other methods.' },
    ...
    sections: [
      ...
      { heading: '4. Langganan dan Pembayaran', items: [
        { label: 'Akses Gratis (Free Tier)', text: 'Pengguna yang belum berlangganan tetap dapat menggunakan layanan dengan batasan berikut:', bullets: [
          ...
          'Beberapa fitur dan tab dikunci',
        ]},
        { label: 'Uji Coba Gratis (14 Hari)', text: 'Pengguna baru mendapatkan akses penuh ke seluruh fitur selama 14 hari, termasuk:', bullets: [
          'Hingga 3 generate program',
          'Hingga 3 program tersimpan',
          'Akses penuh ke seluruh fitur dan konten',
        ]},
        { label: 'Langganan Pro (Berbayar)', text: 'Setelah masa trial berakhir, akses penuh memerlukan langganan Pro seharga Rp 19.900 per bulan, dengan manfaat:', bullets: [
          'Hingga 3 generate per periode langganan',
          'Hingga 3 program tersimpan',
          'Akses penuh ke semua fitur tanpa batasan',
        ]},
        { label: 'Status Berakhir (Expired)', text: 'Jika trial atau langganan berakhir, akun akan kembali ke akses gratis dengan pembatasan:', bullets: [
          'Hanya 1 program terbaru yang dapat diakses',
          'Program lainnya akan terkunci',
          'Fitur tertentu tidak dapat digunakan',
        ]},
        { label: 'Pembayaran', text: 'Pembayaran diproses secara aman melalui Midtrans dan mendukung QRIS, GoPay, ShopeePay, Virtual Account, dan metode lainnya.' },
  ...
  zh: {
    ...
    sections: [
      ...
      { heading: '4. 订阅与付款', items: [
        ...
        { label: '付费订阅（Pro）', text: '试用结束后，需订阅Pro版本（Rp 19,900/月）以获得完整功能：', bullets: [
          '每个订阅周期最多3次生成',
          '最多保存3个计划',
          '完整访问所有功能，无限制',
        ]},
        { label: '过期状态（Expired）', text: '当试用或订阅结束后，账户将恢复为免费账户，并受到以下限制：', bullets: [
          '仅可访问最新的计划',
          '其他计划将被锁定',
          '部分功能不可使用',
        ]},
        { label: '支付方式', text: '支付通过Midtrans安全处理，支持QRIS、GoPay、ShopeePay、虚拟账户等方式。' },
