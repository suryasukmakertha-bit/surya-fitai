  ...
  en: {
    ...
    sections: [
      ...
      { heading: '4. Subscription and Payments', items: [
        ...
        { label: 'Payment', text: 'Processed securely through Xendit (QRIS, Virtual Account, etc.) or ShopeePay manual transfer.' },
  ...
  id: {
    ...
    sections: [
      ...
      { heading: '4. Langganan dan Pembayaran', items: [
        ...
        { label: 'Pembayaran', text: 'Diproses dengan aman melalui Xendit (QRIS, Virtual Account, dll.) atau transfer ShopeePay manual.' },
  ...
  zh: {
    ...
    sections: [
      ...
      { heading: '4. 订阅与付款', items: [
        ...
        { label: '付款方式', text: '通过Xendit（QRIS、虚拟账户等）或ShopeePay人工转账安全处理。' },
